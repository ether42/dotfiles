...
Display some guides to reflect the indentation level:
#+begin_src
(use-package highlight-indent-guides
  ...
  :config
  (setq highlight-indent-guides-method 'character ; unfortunately, means it's copy/pastable
        highlight-indent-guides-responsive 'stack
        highlight-indent-guides-character ?\| ; I prefer ASCII characters
